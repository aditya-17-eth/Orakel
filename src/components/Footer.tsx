        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-sm text-text-muted leading-relaxed">
              Uncompromising data infrastructure for decentralized applications.
            </p>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-text-muted">
              ...
              <Link href="/dashboard" className="block hover:text-neon-cyan transition-colors duration-200">Network Status</Link>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-text-muted">
              <a href="#" className="block hover:text-ultra-magenta transition-colors duration-200">GitHub</a>
              <a href="#" className="block hover:text-ultra-magenta transition-colors duration-200">Discord</a>
              <a href="#" className="block hover:text-ultra-magenta transition-colors duration-200">Twitter</a>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2 text-sm text-text-muted">
              <a href="#" className="block hover:text-electric-lime transition-colors duration-200">Whitepaper</a>
              <a href="#" className="block hover:text-electric-lime transition-colors duration-200">Audit Reports</a>
              <a href="#" className="block hover:text-electric-lime transition-colors duration-200">Bug Bounty</a>
            </div>
          </div>
        </div>
