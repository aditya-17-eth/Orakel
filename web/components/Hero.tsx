...
void main(){gl_Position=position;}`;
  ...
  // Renderer classes are intentionally scoped to this canvas hook.
  useEffect(() => {
    if (!canvasRef.current) return;
...
const Hero: React.FC<HeroProps> = ({
  ...
  return (
    <div className={`relative w-full h-[calc(100vh-3.5rem)] min-h-[500px] overflow-hidden bg-black ${className}`}>
      <canvas
        ref={canvasRef}
      ...
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-white bg-black/30">
        ...
        <div className="text-center space-y-6 max-w-5xl mx-auto px-4">
          ...
          <div className="space-y-2">
            <h1 className="text-5xl md:text-7xl lg:text-8xl font-bold bg-gradient-to-r from-orange-400 via-yellow-400 to-amber-300 bg-clip-text text-transparent animate-fade-in-up animation-delay-200">
              {headline.line1}
            </h1>
