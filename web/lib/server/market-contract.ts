import { Account, Address, BASE_FEE, Networks, Operation, TransactionBuilder, nativeToScVal, rpc, scValToNative, xdr } from "@stellar/stellar-sdk";
...
function bool(value: boolean) { return xdr.ScVal.scvBool(value); }
