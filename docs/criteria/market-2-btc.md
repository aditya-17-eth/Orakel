# Resolution Criteria — Will BTC/USD be at or above $63,000.00 at 2026-07-18 02:32:40 UTC?

**Market ID:** [fill after create_market] · **Category:** crypto-price
**Created:** 2026-07-18 · **Template version:** 1.0
...
> Will BTC/USD be at or above $63,000.00 at 2026-07-18 02:32:40 UTC?
...
63000.00** at the first reading at or after the resolve timestamp in §1.

Edge rules:
- **Equality counts as YES** (price exactly 63000.00 → YES).
...
the resolve timestamp is below 63000.00.
...
| Event | Time (UTC) |
|---|---|
| Trading locks (`lock_time`) | 2026-07-18 01:02:40 UTC |
| Earliest resolution proposal (`resolve_time`) | 2026-07-18 02:32:40 UTC |
| Dispute window | 900 s (15 min) after proposal |
